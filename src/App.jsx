...
export default function App(){
  ...
  const timeOf=(e)=>{if(!e.starts_at)return null;const d=new Date(e.starts_at);const uh=d.getUTCHours(),um=d.getUTCMinutes();if(um===0&&(uh===6||uh===7))return null;return new Intl.DateTimeFormat("en-US",{timeZone:"America/Denver",hour:"numeric",minute:"2-digit",hour12:true}).format(d);};
    ...
    <>
      ...
      <div className="app-shell" style={{width:"100%",maxWidth:430,height:"100%",display:"flex",flexDirection:"column",background:T.fog,fontFamily:"'Inter',sans-serif",margin:"0 auto"}}>
        ...
        <nav style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:430,background:"rgba(245,243,239,0.97)",backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)",borderTop:`0.5px solid ${T.stone}`,display:"flex",flexDirection:"column",zIndex:50,padding:"10px 0 max(16px,env(safe-area-inset-bottom))"}}>
          <p style={{fontFamily:"'Inter',sans-serif",fontSize:9,color:"#7A9583",textAlign:"center",padding:"0 10px",marginBottom:8}}>Before heading out, verify date, time, locations. We're good... not perfect.<br/>© 2026 Go Janey LLC · <a href="mailto:support@gojaney.com" style={{color:"inherit"}}>support@gojaney.com</a></p>
